...
function NavUpdated() {
  ...
  return (
    <div className="fixed top-0 z-10 max-w-2xl w-full bg-white">
      {menu && (
        <div className=" fixed top-[-8px] z-50 w-full h-full bg-white">
          <div className="h-screen">
            <motion.div className="flex items-center justify-between mx-3 pt-2 my-3 sm:mx-6 sm:my-3">
              <Link href="/" className="">
                <img src="/logo.png" alt="logo" className="h-8 sm:h-12"></img>
              </Link>
      ...
      <div className="">
        <div className="flex items-center justify-around mx-3 my-3 sm:mx-6 sm:my-3">
          <Link href="/" className="">
            <img src="/logo.png" alt="logo" className="h-8 sm:h-12"></img>
          </Link>
      ...
      {/* <button className=" py-2 px-3 font-bold rounded-xl border-black border-2  absolute z-50 bottom-5 bg-white right-5">
        MENU
      </button> */}
    </div>
  );
